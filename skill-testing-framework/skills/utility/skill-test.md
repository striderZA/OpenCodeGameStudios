...
- **audit**: Produces a coverage table of all skills in `.opencode/skills/` and
  all agents in `.opencode/agents/`, showing which have spec files and which do not.
...
**Fixture:**
- `.opencode/skills/some-skill/SKILL.md` has `Write` in `allowed-tools` frontmatter
...
- `.opencode/skills/gate-check/SKILL.md` exists
...
**Fixture:**
- `.opencode/skills/` contains 72+ skill directories
- `.opencode/agents/` contains 49+ agent files
- `tests/skills/` contains spec files for a subset of skills

**Input:** `/skill-test audit`

**Expected behavior:**
1. Skill enumerates all skills in `.opencode/skills/` and all agents in `.opencode/agents/`
...
- `.opencode/skills/gate-check/SKILL.md` is a gate skill
