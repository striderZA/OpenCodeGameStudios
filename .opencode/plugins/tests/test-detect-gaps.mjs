 ...
 *
 * Mapping: S1-S15 cover each branch.
 */
...
describe("detect-gaps hook tests", () => {

  // ── S1: Fresh project — no AGENTS.md, no game concept, no source ──
  it("S1: Fresh project suggests /start", () => {
  ...
  it("S2: Unconfigured AGENTS.md \u2192 fresh project", () => {
    const root = makeTempProject()
  ...
  it("S3: Configured project \u2014 no gap warnings", () => {
    const root = makeTempProject()
  ...
  it("S4: 55 source files but 2 design docs \u2014 gap warning", () => {
    const root = makeTempProject()
    fs.writeFileSync(path.join(root, "AGENTS.md"), "- **Engine**: Godot 4\n", "utf8")
    fs.mkdirSync(path.join(root, "design", "gdd"), { recursive: true })
    fs.writeFileSync(path.join(root, "design", "gdd", "game-concept.md"), "# Concept", "utf8")
  ...
  it("S5: 55 files + 7 design docs \u2014 no gap", () => {
    const root = makeTempProject()
    fs.writeFileSync(path.join(root, "AGENTS.md"), "- **Engine**: Godot 4\n", "utf8")
    fs.mkdirSync(path.join(root, "design", "gdd"), { recursive: true })
    fs.writeFileSync(path.join(root, "design", "gdd", "game-concept.md"), "# Concept", "utf8")
  ...
  it("S6: Reports undocumented prototypes", () => {
    const root = makeTempProject()
    fs.writeFileSync(path.join(root, "AGENTS.md"), "- **Engine**: Godot 4\n", "utf8")
    fs.mkdirSync(path.join(root, "design", "gdd"), { recursive: true })
    fs.writeFileSync(path.join(root, "design", "gdd", "game-concept.md"), "# Concept", "utf8")
  ...
  it("S7: Core dir exists but no arch docs", () => {
    const root = makeTempProject()
    fs.writeFileSync(path.join(root, "AGENTS.md"), "- **Engine**: Godot 4\n", "utf8")
    fs.mkdirSync(path.join(root, "design", "gdd"), { recursive: true })
    fs.writeFileSync(path.join(root, "design", "gdd", "game-concept.md"), "# Concept", "utf8")
  ...
  it("S8: Core exists but only 1 ADR (< 3)", () => {
    const root = makeTempProject()
    fs.writeFileSync(path.join(root, "AGENTS.md"), "- **Engine**: Godot 4\n", "utf8")
    fs.mkdirSync(path.join(root, "design", "gdd"), { recursive: true })
    fs.writeFileSync(path.join(root, "design", "gdd", "game-concept.md"), "# Concept", "utf8")
  ...
  it("S9: Core exists with 3 ADRs \u2014 no gap", () => {
    const root = makeTempProject()
    fs.writeFileSync(path.join(root, "AGENTS.md"), "- **Engine**: Godot 4\n", "utf8")
    fs.mkdirSync(path.join(root, "design", "gdd"), { recursive: true })
    fs.writeFileSync(path.join(root, "design", "gdd", "game-concept.md"), "# Concept", "utf8")
  ...
  it("S10: Combat (7 files, no doc) flagged; inventory (3 files) not flagged", () => {
    const root = makeTempProject()
    fs.writeFileSync(path.join(root, "AGENTS.md"), "- **Engine**: Godot 4\n", "utf8")
    fs.mkdirSync(path.join(root, "design", "gdd"), { recursive: true })
    fs.writeFileSync(path.join(root, "design", "gdd", "game-concept.md"), "# Concept", "utf8")
  ...
  it("S11: Combat with design/gdd/combat.md \u2014 no gap", () => {
    const root = makeTempProject()
    fs.writeFileSync(path.join(root, "AGENTS.md"), "- **Engine**: Godot 4\n", "utf8")
    fs.mkdirSync(path.join(root, "design", "gdd"), { recursive: true })
    fs.writeFileSync(path.join(root, "design", "gdd", "game-concept.md"), "# Concept", "utf8")
  ...
  it("S12: 101+ files without sprints/milestones \u2014 gap", () => {
    const root = makeTempProject()
    fs.writeFileSync(path.join(root, "AGENTS.md"), "- **Engine**: Godot 4\n", "utf8")
    fs.mkdirSync(path.join(root, "design", "gdd"), { recursive: true })
    fs.writeFileSync(path.join(root, "design", "gdd", "game-concept.md"), "# Concept", "utf8")
  ...
  it("S13: 101 files with sprint planning \u2014 no gap", () => {
    const root = makeTempProject()
    fs.writeFileSync(path.join(root, "AGENTS.md"), "- **Engine**: Godot 4\n", "utf8")
    fs.mkdirSync(path.join(root, "design", "gdd"), { recursive: true })
    fs.writeFileSync(path.join(root, "design", "gdd", "game-concept.md"), "# Concept", "utf8")
  ...
  it("S14: Exactly 50 source files \u2014 no code/design gap", () => {
    const root = makeTempProject()
    fs.writeFileSync(path.join(root, "AGENTS.md"), "- **Engine**: Godot 4\n", "utf8")
    fs.mkdirSync(path.join(root, "design", "gdd"), { recursive: true })
    fs.writeFileSync(path.join(root, "design", "gdd", "game-concept.md"), "# Concept", "utf8")
  ...
  it("S15: src/ with only non-source files \u2014 0 source files counted", () => {
    const root = makeTempProject()
    fs.writeFileSync(path.join(root, "AGENTS.md"), "- **Engine**: Godot 4\n", "utf8")
    fs.mkdirSync(path.join(root, "src"), { recursive: true })
