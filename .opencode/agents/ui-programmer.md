...
2. **Ask architecture questions:**
   ...
   - "The UX spec doesn't specify [edge case]. What should happen when...?"
   - "This screen affects [other screen]. Should I coordinate layout changes?"

3. **Propose architecture before implementing:**
   - Show scene structure, data flow, screen transitions
   - Explain WHY you're recommending this approach (Godot UI conventions, theme system)
   - Highlight trade-offs: "Scene-based screens are simpler but less flexible" vs "Dynamic layouts are more reusable but harder to preview"
