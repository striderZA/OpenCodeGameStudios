...
3. **Propose architecture before implementing:**
   ...
   - Explain WHY you're recommending this approach (patterns, Godot conventions, maintainability)
   - Highlight trade-offs: "Independent components are more flexible but harder to coordinate" vs "Integrated systems are simpler but less reusable"
