...
Verify `.opencode/skills/[name]/SKILL.md` exists. If not, stop with:
...
Read the full skill file at `.opencode/skills/[name]/SKILL.md`.
...
Ask: "May I write this improved version to `.opencode/skills/[name]/SKILL.md`?"
...
Write the improved skill to `.opencode/skills/[name]/SKILL.md`.
...
If yes: run `git checkout -- .opencode/skills/[name]/SKILL.md`
