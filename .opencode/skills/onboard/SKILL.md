...
Read AGENTS.md (or CLAUDE.md for Claude Code projects) for project overview and standards.
...
[Summary of conventions relevant to this role from AGENTS.md (or `CLAUDE.md` for Claude Code projects) and agent definition]
