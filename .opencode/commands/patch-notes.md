...
> Arguments: ${ARGUMENTS}
> Usage: /patch-notes ${ARGUMENTS}
> Hint: version] [--style brief|detailed|full
...
1. Check `.opencode/docs/technical-preferences.md` for any "tone", "voice", or "style"
   fields or sections.
...
1. Glob for `docs/patch-notes-template.md` and `.opencode/docs/templates/changelog-template.md`.
