...
> Arguments: ${ARGUMENTS}
> Usage: /playtest-report ${ARGUMENTS}
> Hint: new|analyze path-to-notes] [--review full|lean|solo
...
After categorising findings, spawn `creative-director` via Task using gate **CD-PLAYTEST** (`.opencode/docs/director-gates.md`).
