...
> Arguments: ${ARGUMENTS}
> Usage: /story-readiness ${ARGUMENTS}
> Hint: story-file-path or 'all' or 'sprint
...
See `.opencode/docs/director-gates.md` for the full check pattern and mode definitions.
