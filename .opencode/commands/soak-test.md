...
> Arguments: ${ARGUMENTS}
> Usage: /soak-test ${ARGUMENTS}
> Hint: duration: 30m | 1h | 2h | 4h] [focus: memory | stability | balance | all
...
Read:
- `.opencode/docs/technical-preferences.md` — engine (for engine-specific memory
