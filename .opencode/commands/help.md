...
> Hint: optional: what you just finished,e.g. 'finished design-review' or 'stuck on ADRs
...
After reading the catalog, Glob `.opencode/commands/*/SKILL.md` to get the full list
