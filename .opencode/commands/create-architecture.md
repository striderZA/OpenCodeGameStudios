...
> Arguments: ${ARGUMENTS}
> Usage: /create-architecture ${ARGUMENTS}
> Hint: focus-area: full | layers | data-flow | api-boundaries | adr-audit] [--review full|lean|solo
...
3. `.opencode/docs/technical-preferences.md` — naming conventions, performance budgets,
