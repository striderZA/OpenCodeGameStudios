...
user-invocable: true
allowed-tools: Read, Glob, Grep, Bash, Write, question
---
...
3. **Engine detection**: read `docs/framework/technical-preferences.md` and
...
"Engine not configured in `docs/framework/technical-preferences.md`. Run
