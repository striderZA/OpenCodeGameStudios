...
**Argument:** `$ARGUMENTS` (blank = ask user via question)
...
**Engine**: [engine name from docs/framework/technical-preferences.md, or "Not configured"]
...
- Use `question` for scope selection when no argument is provided.
