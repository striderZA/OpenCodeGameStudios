...
See `docs/framework/technical-preferences.md` → Engine Specialists → File Extension Routing.

When in doubt, use the primary engine specialist configured in `docs/framework/technical-preferences.md`.
